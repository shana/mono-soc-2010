...
namespace MonoDevelop.FSharp.Project
{
	internal partial class CodeGenerationPanelWidget
	{
		...
		private global::Gtk.CheckButton generateTailCallsCheckbox;

		private global::Gtk.CheckButton crossModuleOptimizationCheckBox;
		...
		protected virtual void Build ()
		{
			...
			w6.Fill = false;
			// Container child vbox65.Gtk.Box+BoxChild
			this.generateTailCallsCheckbox = new global::Gtk.CheckButton ();
			this.generateTailCallsCheckbox.CanFocus = true;
			this.generateTailCallsCheckbox.Name = "generateTailCallsCheckbox";
			this.generateTailCallsCheckbox.Label = global::Mono.Unix.Catalog.GetString ("Tail calls");
			this.generateTailCallsCheckbox.DrawIndicator = true;
			this.generateTailCallsCheckbox.UseUnderline = true;
			this.vbox65.Add (this.generateTailCallsCheckbox);
			global::Gtk.Box.BoxChild w7 = ((global::Gtk.Box.BoxChild)(this.vbox65[this.generateTailCallsCheckbox]));
			w7.Position = 4;
			w7.Expand = false;
			w7.Fill = false;
			// Container child vbox65.Gtk.Box+BoxChild
			this.crossModuleOptimizationCheckBox = new global::Gtk.CheckButton ();
			this.crossModuleOptimizationCheckBox.CanFocus = true;
			this.crossModuleOptimizationCheckBox.Name = "crossModuleOptimizationCheckBox";
			this.crossModuleOptimizationCheckBox.Label = global::Mono.Unix.Catalog.GetString ("Enable cross-module optimization");
			this.crossModuleOptimizationCheckBox.DrawIndicator = true;
			this.crossModuleOptimizationCheckBox.UseUnderline = true;
			this.vbox65.Add (this.crossModuleOptimizationCheckBox);
			global::Gtk.Box.BoxChild w8 = ((global::Gtk.Box.BoxChild)(this.vbox65[this.crossModuleOptimizationCheckBox]));
			w8.Position = 5;
			w8.Expand = false;
			w8.Fill = false;
			// Container child vbox65.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w9 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.comboPlatforms]));
			w9.Position = 0;
			w9.Expand = false;
			w9.Fill = false;

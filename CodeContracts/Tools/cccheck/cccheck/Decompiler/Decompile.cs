...
namespace cccheck.Decompiler {
	...
	public class Decompile {
		...
		private Expr ProcessInst (Instruction inst)
		{
			...
			case Code.Ldarg_2:
			case Code.Ldarg_3:
				return this.gen.LoadArg (this.method.Parameters [(int) (opcode - Code.Ldarg_0)]);
			case Code.Ldarg_S:
			...
			case Code.Ldloc_2:
			case Code.Ldloc_3:
				return this.gen.LoadLocal (this.method.Body.Variables [(int) (opcode - Code.Ldloc_0)]);
			case Code.Stloc_0:
			case Code.Stloc_1:
			case Code.Stloc_2:
			case Code.Stloc_3:
				return this.ProcessStoreLocal (this.method.Body.Variables [(int) (opcode - Code.Stloc_0)]);
			case Code.Ldnull:
			...
			case Code.Ldlen:
				return this.ProcessLoadLength ();
			default:
				throw new NotSupportedException ("Cannot handle opcode: " + inst.OpCode);
			}
		}

		private Expr ProcessStoreLocal (VariableDefinition variable)
		{
			Expr value = this.exprs.Pop ();
			return this.gen.StoreLocal (variable, value);
		}
		...
		private Expr ProcessLoadLength ()
		{
			Expr array = this.exprs.Pop ();
			return this.gen.LoadLength (array);
		}

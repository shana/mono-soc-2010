...
namespace cccheck.Visitors {
	public abstract class ExprVisitor {
		...
		public virtual Expr Visit (Expr e)
		{
			...
			case ExprType.LoadLocal:
				return this.VisitLoadLocal ((ExprLoadLocal) e);
			case ExprType.StoreLocal:
				return this.VisitStoreLocal ((ExprStoreLocal) e);
			...
			case ExprType.LoadLength:
				return this.VisitLoadLength ((ExprLoadLength) e);
			default:
		...
		protected virtual Expr VisitLoadLocal (ExprLoadLocal e)
		{
			return e;
		}

		protected virtual Expr VisitStoreLocal (ExprStoreLocal e)
		{
			return this.VisitCollection (e, exprs => new ExprStoreLocal (e.MethodInfo, e.Variable, exprs.First ()), e.Value);
		}
		...
		protected virtual Expr VisitLoadLength (ExprLoadLength e)
		{
			return this.VisitCollection (e, exprs => new ExprLoadLength (e.MethodInfo, exprs.First ()), e.Array);
		}

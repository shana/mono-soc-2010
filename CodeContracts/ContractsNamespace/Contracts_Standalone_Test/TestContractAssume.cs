...
namespace ContractsTests {
    ...
    class TestContractAssume : TestContractBase {
        ...
        public void TestAssumeMessage ()
        {
            ...
            Assert.That (base.asserts.Asserts [0].Message, Is.EqualTo ("Description: Assumption failed."));
            Assert.That (base.asserts.Asserts [1].Message, Is.EqualTo ("Description: Assumption failed.  Message"));
        }
